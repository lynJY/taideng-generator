...
public class MetaValidator {
    ...
    public static void validAndFillModelConfig(Meta meta) {
        ...
        for (Meta.ModelConfig.ModelInfo modelInfo : modelInfoList) {
            ...
            String abbr = modelInfo.getAbbr();
            if(StrUtil.isEmpty(abbr)){
                modelInfo.setAbbr(modelInfo.getFieldName());
            }
        }
    }
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "anonymous");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.anonymous");
